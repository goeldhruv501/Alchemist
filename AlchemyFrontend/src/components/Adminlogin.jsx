...
export default function Adminlogin({setOtpVerify}) {

  const navigate = useNavigate()

  const [value, setValue]= useState()

  const ChangeValueInAdminLogIn =(e)=>{
    ...
    <div>
      ...
      <form>
        <div className="mb-4">
          ...
          <input
            onChange={ChangeValueInAdminLogIn}
            name="userName"
            type="userName"
            id="email"
